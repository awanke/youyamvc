...
function relate(chechbox,id){
    var ${oneJavaField} = $("#${oneJavaField}").val()
    var url;
    if(!$(chechbox).is(":checked")){
        url = "admin/teacher/delete_relate/"+${oneJavaField}+"/"+id;
    }else{
        url = "admin/teacher/add_relate/"+${oneJavaField}+"/"+id;
    }
...
function  getItemPage(pageIndex){
    ...
    var url ='admin/teacher/page_relate/'+pageIndex+'/'+pageCount;
